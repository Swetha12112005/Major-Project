# -*- coding: utf-8 -*-
"""Student placement.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/15WduG_xzhEGwDhDEOTd4te5S3U_OPW87
"""
...
# ---------------------------------------------------------
print("⏳ Starting GridSearch for Optimal Parameters (This might take 1-2 mins)...")
...
print(f"\n📊 Final Hold-Out Test Accuracy: {accuracy_score(y_test, y_pred) * 100:.2f}%")
print("\n--- Detailed Report ---")
